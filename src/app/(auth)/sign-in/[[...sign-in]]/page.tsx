...
export default function Page() {
  return (
    <div className="flex container justify-center items-center h-screen">
      <div className="flex w-[70%] h-[460px] p-[20px] rounded-[25px] bg-[#131313] ">
      ...
      <div className="h-[40px] flex flex-col justify-center items-center mt-4">
            ...
            <p className="text-[10px]">We are glad to see you back with us</p>
            </div>
            <Input type="text" placeholder="Username" className="mt-[3rem]"/>
            ...
            <Button variant='outline' className="w-full mt-[20px] border-[#ff6200] text-[#ff6200] bg-[#131313]">Sign up</Button>
          </div>
          <div className="w-[50%] h-full rounded-[20px]">
            <img src="/assets/signin.png" alt="Not Found" className="h-full" />
        </div>
      </div>
    </div>
  );
