...
export default function Page() {
  return (
    <div className="h-[90vh] w-full flex items-center justify-center">
      <div className="w-4/5 h-5/6 md:h-4/6 lg:h-5/6 flex rounded-[54px] bg-[#131313]">
        <div className="  w-full md:w-3/6 h-full flex flex-col items-center justify-center">
         <div className=" flex flex-col justify-center items-center">
            <img src="/assets/logo.png" alt="" className="h-[60px] lg:h-[70px]"/>
            <p className="text-[10px] md:text-[13px] mt-1">We are glad to see you back with us</p>
          </div>
          ...
          <Button variant='outline' className="w-8/12 md:w-7/12 mt-[20px] border-[#ff6200] text-[#ff6200] bg-[#131313]">Sign up</Button>
        </div>   
        <div className="w-3/6 h-full flex justify-center hidden md:block">
        <img src="/assets/signin.png" alt="Not Found" className="h-full w-full p-[40px]"/>
        </div>     
      </div>
    </div>
  );
